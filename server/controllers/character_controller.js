...
{   id:1,
    ...
    name:"Ricky",
    age: "Age: 30",
    occupation: "Occupation: Conman",
    catchphrase: "Quoted: 'Gotta learn stuff through denial and error.'",
...
{   id:2,
    ...
    name:"Julian",
    age: "Age: 32",
    occupation:"Occupation: Master Mind Criminal",
    catchphrase: "Quoted: 'Life isn't about getting drunk and eating chicken fingers all the time.'",
...
{   id:3,
    ...
    name:"Bubbles",
    age: "Age: 31",
    occupation:"Occupation: Kitty Tamer and Shopping Cart Repairman",
    catchphrase:"Quoted: 'That is one Nice Kitty.'",
...
{   id:4,
    ...
    name:"Mr.Lahey",
    age: "Age: 57",
    occupation:"Occupation: Trailer Park Supervisor",
    catchphrase:"Quoted: 'I am the Liqour.'",
...
{   id:5,
    ...
    name:"Randy",
    age: "Age: 30",
    occupation:"Occupation: Assistant Trailer Park Supervisor",
    catchphrase:"Quoted: 'Ive got some cheeseburgers.'",
...
{   id:6,
    ...
    catchphrase:"Quoted: 'That's the way she goes.'",
...
{   id:7,
    ...
    name:"Barb Lahey",
    age: "Age: 56",
    occupation:"Occupation: Trailer Park Owner",
    catchphrase:"Quoted: 'Randy, put a shirt on.'",
